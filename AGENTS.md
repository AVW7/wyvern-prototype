...
When asked for new sanctuary design input, append a review under its
**Multi-model review workspace**. Preserve all prior reviews and leave final
decision statuses to the human project owner.

After material work, append the model and contribution to
`AI_CONTRIBUTIONS.md`. Do not overwrite earlier attribution or register a model
that has not contributed.
